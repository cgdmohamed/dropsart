...
function custom_breadcrumbs()
{
    ...
    $breadcrums_class   = 'breadcrumb breadcrumbs';
    $home_title         = 'الرئيسية';
    ...
    if (!is_front_page()) {
        ...
        if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
            ...
            echo '<li class="breadcrumb-item active item-current item-archive"><strong class="bread-current bread-archive">' . $custom_tax_name . '</strong></li>';
        } else if (is_single()) {
            ...
            if (!empty($category)) {
                ...
                $last_categorys = array_values($category);
                $last_category = end($last_categorys);
            ...
            if (is_array(empty($last_category)) && !empty($custom_taxonomy) && $taxonomy_exists) {
            ...
            if ($post->post_parent) {
                ...
                echo '<li aria-current="page" class="breadcrumb-item breadcrumb-item active item-current item-' . $post->ID . '"><strong class="bread-current bread-' . $post->ID . '"> ' . get_the_title() . '</strong></li>';
            }
        } else if (is_tag()) {
